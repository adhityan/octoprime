...
before(function (cb) {
  getJson('https://api.github.com/repos/adhityan/octotree/git/trees/master?recursive=true', token, function (err, data) {
  ...
  describe(browser, function () {
    before(function (cb) {
      starx(function *() {
        ...
        po = new PageObject(driver, 'https://github.com/adhityan/octotree')
      })(cb)
    })
    ...
    describe('init', function () {
      ...
      yit('should match branches', function *() {
        ...
        yield po.setUrl('https://github.com/adhityan/octotree/tree/v1.6.2')
    ...
    describe('main', function () {
      ...
      describe('tree', function () {
        ...
        yit('should show repository information', function *() {
          ...
          assert.equal(yield links[0].getText(), 'adhityan')
        ...
        yit('should navigate to code files', function *() {
          ...
          for (var i = 0; i < 3; i++) {
            ...
            assert.equal(yield po.getUrl(), 'https://github.com/adhityan/octotree/blob/master/' + someFile.path)
      ...
      describe('opts', function () {
        ...
        describe('values', function () {
          ...
          describe('non-code', function () {
            var pages = [
              'https://github.com/adhityan/octotree/issues',
              'https://github.com/adhityan/octotree/pulls',
              'https://github.com/adhityan/octotree/pulse',
              'https://github.com/adhityan/octotree/graphs/contributors'
            ]
